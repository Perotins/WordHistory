...
import me.perotin.wordhistory.inventory.events.grammar.punctuation.PunctuationEvents;
...
public class WordHistory extends JavaPlugin{
    ...
    public void onEnable(){
        plugin = this;
        players = new HashSet<WordPlayer>();
        WordFile.loadFiles();
        ...
        Bukkit.getPluginManager().registerEvents(new PunctuationEvents(this), this);
